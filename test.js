const user1 = {
  user_email: "reggie@gmail.com",
  user_password: "reggiereggie",
  user_name: "Reggie",
  workouts: [
    {
    ...
    workout1: [
      {
        ...
        difficulty: "beginner",
        instructions:
          "Stand up with your torso upright while holding a barbell at the wide outer handle. The palm of your hands should be facing forward. The elbows should be close to the torso. This will be your starting",
      },
      {
        name: "Wide-grip barbell curl",
        type: "strength",
